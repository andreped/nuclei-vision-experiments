...
H5_WEIGHT_PATH = '/home/andrep/workspace/nuclei/python/Mask_RCNN/samples/nucleus/mask_rcnn_nucleus_0035_test_model.h5' #'/keras_model/mask_rcnn_tags_0001.h5'
MODEL_DIR = os.path.dirname(H5_WEIGHT_PATH)

# Path where the Frozen PB will be save
PATH_TO_SAVE_FROZEN_PB = './frozen_model' #'/frozen_model/'

# Name for the Frozen PB name
FROZEN_NAME = 'mask_frozen_graph.pb'

# PATH where to save serving model
PATH_TO_SAVE_TENSORFLOW_SERVING_MODEL = './serving_model' #'/serving_model'

# Version of the serving model
VERSION_NUMBER = 1

# Number of classes that you have trained your model
NUMBER_OF_CLASSES = 1 # 5
